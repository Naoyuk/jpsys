...
BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS "suppliers" ("id" serial PRIMARY KEY NOT NULL, "name" varchar, "representative" varchar, "email" varchar, "address" varchar, "created_at" timestamp(6) NOT NULL, "updated_at" timestamp(6) NOT NULL);
